...
// Rujia Liu
// https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=850&page=show_problem&problem=4514
// log 数学期望求解 假想法 ，逆向思维，从最后结果回想起
// 本题中log 以e 为底,利用log 函数减少精度损失
#include <cmath>
#include <cstdio>
// C(n,m) = n!/(m!(n-m)!)
